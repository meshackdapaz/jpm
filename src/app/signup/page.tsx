      ...
      <div className="w-full max-w-[380px] space-y-6 relative z-10 px-4 sm:px-0">
        ...
        <form onSubmit={handleSignup} className="space-y-3">
          ...
          <div className="space-y-2">
            ...
            {/* Birthday */}
            <div className="p-4 bg-zinc-100 dark:bg-zinc-900/50 border border-transparent dark:border-zinc-800 rounded-2xl space-y-3">
              <label className="text-[12px] text-zinc-500 font-bold px-1 uppercase tracking-wider block">Birthday</label>
              <div className="grid grid-cols-3 gap-2">
                <select
                  required
                  className="w-full bg-zinc-200/50 dark:bg-zinc-800/50 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 text-[14px] outline-none text-black dark:text-white cursor-pointer appearance-none focus:ring-1 focus:ring-zinc-400"
                  value={birthMonth}
