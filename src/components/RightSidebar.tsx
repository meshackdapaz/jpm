...
export function RightSidebar({ mobile = false }: { mobile?: boolean }) {
  ...
  return (
    <aside className={mobile 
      ...
      {/* Advertisement */}
      <div style={{ minHeight: '300px' }} className="bg-white dark:bg-[#0a0a0a] rounded-[24px] border border-zinc-100 dark:border-zinc-800/80 overflow-hidden shadow-sm p-4 mt-2 flex flex-col">
        <div className="flex items-center justify-between mb-3 px-1">
          <span className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Sponsored</span>
        </div>
        <div className="w-full flex-1 bg-zinc-50 dark:bg-zinc-900/50 rounded-xl overflow-hidden flex items-center justify-center">
