...
let content = fs.readFileSync('src/app/profile/page.tsx', 'utf-8')
...
const oldMap = `            <div className="divide-y divide-zinc-50 dark:divide-zinc-900/50">
              {[
...
const newMap = `            <div className="divide-y divide-zinc-50 dark:divide-zinc-900/50">
              {[
...
const oldActions = `            {/* Bottom Actions */}
...
const newActions = `            {/* Bottom Actions */}
...
fs.writeFileSync('src/app/profile/page.tsx', content, 'utf-8')
console.log("Updated profile/page.tsx successfully!")
